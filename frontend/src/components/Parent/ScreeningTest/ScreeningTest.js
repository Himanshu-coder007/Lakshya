...
const ScreeningTest = () => {
    ...
    const submitQuiz = () => {
        ...
        if (document.querySelectorAll('input[type="radio"]:checked').length !== 12) {
            ...
            const url = `/parent/result/${responses}`;
            navigate(url);
        }
    }
            ...
            <div className={styles.primary}>
                <header>
                    <div className={styles.head}>
                        <h1>Learning Impairement Test </h1>
                    </div>
                </header>
